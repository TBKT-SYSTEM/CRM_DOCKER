...
class ManageQuotation extends CI_Controller
{
    ...
    {
        // $this->another_css = '<link rel="stylesheet" href="' . base_url() . 'assets/libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">';
        ...
        // $this->another_js .= "<script src='" . base_url() . "assets/js/extra-libs/moment/moment.min.js'></script>";
        // $this->another_js .= "<script src='" . base_url() . "assets/libs/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js'></script>";
        // $this->another_js .= "<script src='" . base_url() . "assets/js/forms/datepicker-init.js'></script>";
        $this->render_view('view_mngQuotation');
    }
}

...
class ManageBackend extends CI_Model
{
    ...
    public function createFileImage($fileupload, $tempFileLogo, $user)
    {
        ...
        $fileNameWithoutSpaces = str_replace(' ', '_', $arrStrLogo[0]);
        $fileNameLogo = $timestamp . "_" . $fileNameWithoutSpaces . "." . $arrStrLogo[1];
    ...
    public function sent_pswToMail($data)
    {
        ...
        $this->email->from("tanasidphakdeechot@gmail.com", 'SYSTEM SERVICE');

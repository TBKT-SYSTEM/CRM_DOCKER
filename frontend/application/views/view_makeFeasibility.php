                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-3 d-flex justify-content-center gap-3">
                                                    ...
                                                    <!-- <div class="col">
                                                        <label for="if_ref" class="form-label fw-semibold">Test IR_REF</label>
                                                        <input type="text" name="if_ref" id="if_ref" class="form-control" placeholder="Enter Customer Name">
                                                        <span class="form_error"></span>
                                                    </div> -->
                                                </div>

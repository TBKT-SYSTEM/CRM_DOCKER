...
(function(global, factory) {
    ...
    var defaultOptions = {
        ...
        labelIdle: [
            '<img src="assets/images/profile/file-removebg-preview.png" class="img-fluid">Drag & Drop your files or <span class="filepond--label-action">Browse</span>',
            Type.STRING,
        ],
    ...
    var create$e = function create(_ref) {
        ...
        if (hasCredits) {
            ...
            frag.className = 'filepond--credits d-none';
            frag.href = credits[0];
            frag.tabIndex = -1;
            frag.target = '_blank';
